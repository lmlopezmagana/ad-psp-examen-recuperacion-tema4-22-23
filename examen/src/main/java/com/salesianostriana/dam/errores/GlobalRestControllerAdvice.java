...
public class GlobalRestControllerAdvice extends ResponseEntityExceptionHandler {
    ...
    // TODO Aquí debes incluir un método para manejar la excepción de validación del Email
        ...
        return buildApiErrorWithSubError(HttpStatus.BAD_REQUEST,
                ...
                ex.getConstraintViolations()
                        ...
                        .map(cv -> ApiValidationSubError.builder()
                                ...
                                // TODO Aquí faltan dos valores para devolver el objeto de forma completa
                                .build())
